...
它最常和 [NumPy](./numpy.md) 配合使用，像 [FFT代码实现](../Math/FFT.md) 和 [线性回归的推导](../Math/regression.md) 这类笔记里的结果图，最后都要靠 Matplotlib 落地。
...
如果是表格数据的快速出图，通常会从 [Pandas](./pandas.md) 直接挂接到 Matplotlib。
